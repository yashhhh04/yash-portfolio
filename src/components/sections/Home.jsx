...
export const Home = () => {
  ...
  performance while ensuring a seamless and delightful user experience.</p>
        <div className="justify-center flex space-x-4">
          ...
          <a
            href="#contact"
            className="border border-blue-500/50 text-blue-500 py-3 px-6 rounded transition-all duration-200 font-medium hover:-translate-y-0.5 hover:shadow-[0_0_15px_rgba(59,130,246,0.2)] hover:bg-blue-500/10"
          >
            Contact Me
          </a>
        </div>
